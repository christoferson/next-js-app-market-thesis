  ...
  return (
    <div className="max-w-2xl space-y-6">
      <h1 className="text-2xl font-semibold tracking-tight text-stone-900">
        Company not found in the research universe
      </h1>

      <div className="space-y-3 rounded-md border border-stone-300 bg-white p-6">
        <p className="text-sm leading-relaxed text-stone-700">
          No company in the current research universe matches this identifier.
          The link may be misspelled, or the company may not be part of the
          curated starter set yet.
        </p>
        <p className="text-sm leading-relaxed text-stone-700">
          No filings were requested, so no figures on this page describe any
          company.
        </p>
      </div>
